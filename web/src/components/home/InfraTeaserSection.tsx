        ...
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              {image && (
                <>
                  <ConfigImage sizes="(max-width: 639px) 100vw, (max-width: 1023px) 50vw, 33vw" loading="lazy" decoding="async" src={image} alt={item.label} className="aspect-[4/3] w-full object-cover" />
