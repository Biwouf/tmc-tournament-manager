...
interface Props {
  value: number;
  tb?: number | null;
  /** Désactive l'animation (set terminé, set inactif, etc.). */
  animate?: boolean;
  /** Durée du flip en ms (défaut 400). */
  durationMs?: number;
  /** Classes Tailwind appliquées au conteneur de la cellule (tailles, fond, rayon). */
  className?: string;
  /** Classes Tailwind appliquées au <sup> du tiebreak. */
  tbClassName?: string;
}
