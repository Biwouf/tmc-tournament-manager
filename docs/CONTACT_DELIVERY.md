...
- Le 13 septembre 2026 : clé API classique acceptée, secrets local/dev identiques, envoi transactionnel actif, expéditeur `contact@feelike.pro` actif et domaine authentifié.
