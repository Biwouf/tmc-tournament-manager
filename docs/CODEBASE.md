...
| Fichier | Rôle |
|---|---|
| `hooks/useLocalStorage.ts` | Hook générique `useLocalStorage<T>(key, defaultValue)` — **code mort** (importé nulle part ; la persistance TMC se fait dans la table Supabase `tournaments`, pas en localStorage) |
